...
df_microstates.csv and shared_variance.csv are direct outputs from the MICROSTATELAB plugin in EEGLAB. These files are further processesed in psilocybin_microstates.ipynb where statistical analyses and figures are produced.
